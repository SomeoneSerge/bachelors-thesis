...
одним полем,
которое ``уважает'' и ``сохраняет'' их линейную структуру, i.e. такое, что:
\( A:X\to Y \) that \( A(\alpha x_1 + x_2) = \alpha Ax_1 + Ax_2,\
\alpha\in\mathbb{K}, x_i\in X \).

\textbf{Линейная алгебра} --- в.п. \( X \) с ассоциативным
...
если они есть ребро, инцидентное им обоим, i.e. если есть \( e\in E \)
такой что \( \phi(e)\in\{(u, v),\ (v, u) \}\).
\newpage
\section{References}
\nocite{*}
