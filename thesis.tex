...
На самом деле это множество наделено ещё более структурой \emph{Банаховой
  алгебры} --- кроме операции умножения на нём определена субмультипликативная
...
также образует алгебру Банаха, снабженное любой субмультипликативной нормой
    \( \|\cdot\| \):
...
\begin{itemize}
    ...
    \item  \( \Gamma \) удовлетворяет уравнениям:
        \[
...
предлагает систему уравнений для нахождения матрицы подобной \( \mathbb{J}_N -
...
\begin{proof}
  ...
  \]
  Ядро (null-space) матрицы \( \mathbb{J}_N \) ортогонально вектору \( h_N \)
